...
public class Post_DB {
    ...
    public static void add_post(UUID owner_id, String title,String description , UUID channel_id, boolean is_public) {
    ...
    public static String get_ownerID(UUID videoID){
        try{
            Connection connection = create_connection();
            ...
            if(rs.next()){
                return ((UUID) rs.getObject("id")).toString();
            }
